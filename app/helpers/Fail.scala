/** Provide a failure wrapper for controller reporting via the api
  *
  * Taken from Adrien Crovetto's article and Sorus repo here:
  * https://medium.com/@adriencrovetto/error-handling-in-scala-with-play-framework-130034b21b37
  * and here:
  * https://github.com/Driox/sorus/blob/master/app/helpers/Fail.scala
  *
  * Copyright 2014
  *
